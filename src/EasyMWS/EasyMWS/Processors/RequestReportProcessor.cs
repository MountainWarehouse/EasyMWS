    ...
    internal class RequestReportProcessor : IRequestReportProcessor
    {
	    ...
	    public void RequestReportFromAmazon(IReportRequestCallbackService reportRequestService, ReportRequestEntry reportRequestEntry)
	    {
		    ...
		    try
		    {
			    ...
			    _logger.Info($"Report Request was successful for {reportRequestEntry.RegionAndTypeComputed}! [RequestId:'{requestId}',Timestamp:'{timestamp}']",
			    ...
			    else
			    {
					...
					_logger.Info($"AmazonMWS request succeeded for {reportRequestEntry.RegionAndTypeComputed}. ReportRequestId:'{reportRequestEntry.RequestReportId}'");
				}
